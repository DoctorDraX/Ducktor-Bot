exports.commands = {
    ...
    challenge: function(arg, by, room) {
        ...
        var tier = toId(arg[1]);
        if (!TEAMS[toId(arg[1])] && ['battlefactory', 'randombattle', 'seasonalspoopyparty', '[gen1]randombattle', '[gen2]randombattle', '[gen1]challengecup', 'challengecup1v1', 'monotyperandombattle', 'hackmonscup'].indexOf(tier) === -1) return false;
        if (TEAMS[tier]) {
